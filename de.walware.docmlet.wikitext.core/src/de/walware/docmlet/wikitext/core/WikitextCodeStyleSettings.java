...
/*[ Properties ]===============================================================*/
	...
	public void setTabSize(final int size) {
		final int oldValue= this.fTabSize;
		this.fTabSize= size;
	...
	public boolean getReplaceOtherTabsWithSpaces() {
		return this.fReplaceOtherTabsWithSpaces;
	}
