...
public class LtxCommandsPreferencePage extends ConfigurationBlockPreferencePage<TexCommandsConfigurationBlock> {
	...
	@Override
	protected TexCommandsConfigurationBlock createConfigurationBlock() {
